...
export default [
    ...
    ModelGenerator.generateActivity("Funny Lunch", host1, "Come and eat!", ["images/kitchen/kitchen1.png"], 8, location0, new Date(2017, 5, 18, 12, 0), '',[member4, member7, member2, member5]),
    ModelGenerator.generateActivity("Supper", host2, "Come and eat!", ["images/kitchen/kitchen2.png"], 8, location0, new Date(2017, 5, 18, 18, 0), '', [member7, member6, member1, member3]),
    ModelGenerator.generateActivity("Breakfast", host3, "Come and eat!", ["images/kitchen/kitchen3.png"], 8, location0, new Date(2017, 5, 18, 9, 0),'', [member2, member1, member4, member5]),
];